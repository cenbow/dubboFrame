...
MySQL - 5.6.21-log : Database - shiro
*********************************************************************
*/
...
insert  into `sys_permission`(`id`,`name`,`type`,`url`,`percode`,`parentid`,`parentids`,`sortstring`,`available`) values (1,'权限','','',NULL,0,'0/','0','1'),(11,'商品管理','menu','/items/queryItem.action',NULL,1,'0/1/','1.','1'),(12,'商品新增','permission','/items/add.action','item:create',11,'0/1/11/','','1'),(13,'商品修改','permission','/items/editItem.action','item:update',11,'0/1/11/','','1'),(14,'商品删除','permission','','item:delete',11,'0/1/11/','','1'),(15,'商品查询','permission','/items/queryItem.action','item:query',11,'0/1/15/',NULL,'1'),(21,'用户管理','menu','/user/query.action','user:query',1,'0/1/','2.','1'),(22,'用户新增','permission','','user:create',21,'0/1/21/','','1'),(23,'用户修改','permission','','user:update',21,'0/1/21/','','1'),(24,'用户删除','permission','','user:delete',21,'0/1/21/','','1');
...
insert  into `sys_user`(`id`,`usercode`,`username`,`password`,`salt`,`locked`) values ('lisi','lisi','李四','96e79218965eb72c92a549dd5a330112','uiwueylm','0'),('zhangsan','zhangsan','张三','cb571f7bd7a6f73ab004a70322b963d5','eteokues','0');
...
CREATE TABLE `tuser` (
  `id` varchar(36) NOT NULL COMMENT '主键',
  `createdatetime` date DEFAULT NULL COMMENT '账号',
  `modifydatetime` date DEFAULT NULL COMMENT '姓名',
  `name` varchar(32) DEFAULT NULL COMMENT '密码',
  `pwd` varchar(64) DEFAULT NULL COMMENT '盐',
  `createTime` date DEFAULT NULL COMMENT '账号是否锁定，1：锁定，0未锁定',
  `updateTime` date DEFAULT NULL COMMENT '账号是否锁定，1：锁定，0未锁定',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tuser` */

insert  into `tuser`(`id`,`createdatetime`,`modifydatetime`,`name`,`pwd`,`createTime`,`updateTime`) values ('1','2016-06-08','2016-06-08','ddddd','eeeeee','2016-06-08','2016-06-08');
